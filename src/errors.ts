...
export const generalErrorCodeToReason: {
  ...
  [GeneralErrorCodes.UnableToSubmitOnBehalfOfTaker]:
    "Unable to submit transaction on behalf of taker",
  [GeneralErrorCodes.InvalidAPIKey]: "Invalid API key",
  [GeneralErrorCodes.ServiceDisabled]: "Service disabled",
  [GeneralErrorCodes.InsufficientFundsError]:

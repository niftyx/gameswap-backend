...
export function createSRARouter(orderBook: OrderBookService): express.Router {
  ...
  router.get(
    "/asset_pairs",
    asyncHandler(handlers.assetPairsAsync.bind(handlers))
  );
  /**
  ...
  router.get(
    "/orderbook",
    asyncHandler(handlers.orderbookAsync.bind(handlers))
  );
  /**
  ...
  router.post(
    "/order/persistent",
    asyncHandler(handlers.postPersistentOrderAsync.bind(handlers))
  );
  /**
  ...
  router.get(
    "/order/:orderHash",
    asyncHandler(handlers.getOrderByHashAsync.bind(handlers))
  );
  return router;
}
